(() => {
  ...
  function renderResults(q, plates){
    let html = `<p class="v2-address-section">線上門牌（國土測繪）（${plates.length}）</p>`;
  ...
  controls.searchBtn?.addEventListener("click", ()=> performSearch());
